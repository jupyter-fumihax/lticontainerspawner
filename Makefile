...
install: 
	...
	[ -f /usr/local/etc/ltictr/notice_active.txt ]                 || install -m 0640 etc/notice_active.txt                 /usr/local/etc/ltictr
	[ -f /usr/local/etc/ltictr/notice_memory.txt ]                 || install -m 0640 etc/notice_memory.txt                 /usr/local/etc/ltictr
	...
	install -m 0755 etc/jupyterhub_notice.js     /usr/local/etc
